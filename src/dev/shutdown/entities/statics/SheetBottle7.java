...
/**
 * Diese Klasse dient zum Erstellen eines statischen "Nachrichtentopf 7"-Objektes
 * fuer die Spielwelt welches den "Nachricht 7"-Gegenstand hinterlaesst
 * 
 * @author Felix Hildebrandt
 *
 */
public class SheetBottle7 extends StaticEntity {
	 ...
	 * und die individuelle Kollisionsbox fuer das "Nachrichtentopf 7"-Objekt gesetzt.
	 * 
	 * @param handler Handler des "Nachrichtentopf 7"-Objektes
	 * @param x Position auf der X-Achse in der Spielwelt in Pixel
	 * @param y Position auf der Y-Achse in der Spielwelt in Pixel
	 */
	public SheetBottle7(Handler handler, float x, float y) {
	...
	public void disappear() {
		handler.getMap();
		Maps.getSheetManager().addSheet(Sheet.paperSheet7.createNew((int)x,(int) y));
	}
