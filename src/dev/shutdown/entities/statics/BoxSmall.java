...
/**
 * Diese Klasse dient zum Erstellen eines statischen "kleines Regal"-Objektes
 * fuer die Spielwelt.
 * 
 * @author Felix Hildebrandt
 *
 */
public class BoxSmall extends StaticEntity {
	 ...
	 * und die individuelle Kollisionsbox fuer das "kleines Regal"-Objekt gesetzt.
	 * 
	 * @param handler Handler des "kleinen Regal"-Objektes
	 * @param x Position auf der X-Achse in der Spielwelt in Pixel
	 * @param y Position auf der Y-Achse in der Spielwelt in Pixel
	 */
	public BoxSmall(Handler handler, float x, float y) {
	...
	public void render(Graphics paintbrush) {
		paintbrush.drawImage(Assets.box_small, (int) (x - handler.getGameView().getxOffSet()), (int) (y - handler.getGameView().getyOffSet()), width, height, null);
	}
}
