...
/**
 * Diese Klasse dient zum Erstellen eines statischen "Nachrichtentopf 8"-Objektes
 * fuer die Spielwelt welches den "Nachricht 8"-Gegenstand hinterlaesst. 
 * 
 * @author Felix Hildebrandt
 *
 */
public class SheetBottle8 extends StaticEntity {
	 ...
	 * und die individuelle Kollisionsbox fuer das "Nachrichtentopf 8"-Objekt gesetzt.
	 * 
	 * @param handler Handler des "Nachrichtentopf 8"-Objektes
	 * @param x Position auf der X-Achse in der Spielwelt in Pixel
	 * @param y Position auf der Y-Achse in der Spielwelt in Pixel
	 */
	public SheetBottle8(Handler handler, float x, float y) {
	...
	public void disappear() {
		handler.getMap();
		Maps.getSheetManager().addSheet(Sheet.paperSheet8.createNew((int)x,(int) y));
	}
