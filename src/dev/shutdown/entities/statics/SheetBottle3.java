...
/**
 * Diese Klasse dient zum Erstellen eines statischen "Nachrichtentopf 3"-Objektes
 * fuer die Spielwelt welches den "Nachricht 3"-Gegenstand hinterlaesst.
 * 
 * @author Felix Hildebrandt
 *
 */
public class SheetBottle3 extends StaticEntity {
	 ...
	 * und die individuelle Kollisionsbox fuer das "Nachrichtentopf 3"-Objekt gesetzt.
	 * 
	 * @param handler Handler des "Nachrichtentopf 3"-Objektes
	 * @param x Position auf der X-Achse in der Spielwelt in Pixel
	 * @param y Position auf der Y-Achse in der Spielwelt in Pixel
	 */
	public SheetBottle3(Handler handler, float x, float y) {
	...
	public void disappear() {
		handler.getMap();
		Maps.getSheetManager().addSheet(Sheet.paperSheet3.createNew((int)x,(int) y));
	}
