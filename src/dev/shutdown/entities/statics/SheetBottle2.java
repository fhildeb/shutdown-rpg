...
/**
 * Diese Klasse dient zum Erstellen eines statischen "Nachrichtentopf 2"-Objektes
 * fuer die Spielwelt welches den "Nachricht 2"-Gegenstand hinterlaesst.
 * 
 * @author Felix Hildebrandt
 *
 */
public class SheetBottle2 extends StaticEntity {
	 ...
	 * und die individuelle Kollisionsbox fuer das "Nachrichtentopf 2"-Objekt gesetzt.
	 * 
	 * @param handler Handler des "Nachrichtentopf 2"-Objektes
	 * @param x Position auf der X-Achse in der Spielwelt in Pixel
	 * @param y Position auf der Y-Achse in der Spielwelt in Pixel
	 */
	public SheetBottle2(Handler handler, float x, float y) {
	...
	public void disappear() {
		handler.getMap();
		Maps.getSheetManager().addSheet(Sheet.paperSheet2.createNew((int)x,(int) y));
	}
