...
/**
 * Diese Klasse dient zum Erstellen eines statischen "dunkler Pilz"-Objektes
 * fuer die Spielwelt.
 * 
 * @author Felix Hildebrandt
 *
 */
public class ShroomDark extends StaticEntity {
	 ...
	 * und die individuelle Kollisionsbox fuer das "dunkler Pilz"-Objekt gesetzt.
	 * 
	 * @param handler Handler des "dunkler Pilz"-Objektes
	 * @param x Position auf der X-Achse in der Spielwelt in Pixel
	 * @param y Position auf der Y-Achse in der Spielwelt in Pixel
	 */
	public ShroomDark(Handler handler, float x, float y) {
	...
	public void render(Graphics paintbrush) {
		paintbrush.drawImage(Assets.shroom_dark, (int) (x - handler.getGameView().getxOffSet()), (int) (y - handler.getGameView().getyOffSet()), width, height, null);
	}
}
