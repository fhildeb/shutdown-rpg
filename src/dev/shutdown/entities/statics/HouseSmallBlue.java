...
/**
 * Diese Klasse dient zum Erstellen eines statischen "kleines blaues Haus"-Objektes
 * fuer die Spielwelt.
 * 
 * @author Felix Hildebrandt
 *
 */
public class HouseSmallBlue extends StaticEntity {
	 ...
	 * und die individuelle Kollisionsbox fuer das "kleines blaues Haus"-Objekt gesetzt.
	 * 
	 * @param handler Handler des "kleines blaues Haus"-Objektes
	 * @param x Position auf der X-Achse in der Spielwelt in Pixel
	 * @param y Position auf der Y-Achse in der Spielwelt in Pixel
	 */
	public HouseSmallBlue(Handler handler, float x, float y) {
	...
	public void render(Graphics paintbrush) {
		paintbrush.drawImage(Assets.house_small_blue, (int) (x - handler.getGameView().getxOffSet()), (int) (y - handler.getGameView().getyOffSet()), width, height, null);
	}
}
