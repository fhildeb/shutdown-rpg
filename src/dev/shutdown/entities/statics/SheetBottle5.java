...
/**
 * Diese Klasse dient zum Erstellen eines statischen "Nachrichtentopf 5"-Objektes
 * fuer die Spielwelt welches den "Nachricht 5"-Gegenstand hinterlaesst
 * 
 * @author Felix Hildebrandt
 *
 */
public class SheetBottle5 extends StaticEntity {
	 ...
	 * und die individuelle Kollisionsbox fuer das "Nachrichtentopf 5"-Objekt gesetzt.
	 * 
	 * @param handler Handler des "Nachrichtentopf 5"-Objektes
	 * @param x Position auf der X-Achse in der Spielwelt in Pixel
	 * @param y Position auf der Y-Achse in der Spielwelt in Pixel
	 */
	public SheetBottle5(Handler handler, float x, float y) {
	...
	public void disappear() {
		handler.getMap();
		Maps.getSheetManager().addSheet(Sheet.paperSheet5.createNew((int)x,(int) y));
	}
