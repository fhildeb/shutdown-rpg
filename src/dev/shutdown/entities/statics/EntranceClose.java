...
/**
 * Diese Klasse dient zum Erstellen eines statischen "geschlossener Eingang"-Objektes
 * fuer die Spielwelt.
 * 
 * @author Felix Hildebrandt
 *
 */
public class EntranceClose extends StaticEntity {
	 ...
	 * und die individuelle Kollisionsbox fuer das "geschlossener Eingang"-Objekt gesetzt.
	 * 
	 * @param handler Handler des "geschlossener Eingang"-Objektes
	 * @param x Position auf der X-Achse in der Spielwelt in Pixel
	 * @param y Position auf der Y-Achse in der Spielwelt in Pixel
	 */
	public EntranceClose(Handler handler, float x, float y) {
	...
	public void render(Graphics paintbrush) {
		paintbrush.drawImage(Assets.entrance_close, (int) (x - handler.getGameView().getxOffSet()), (int) (y - handler.getGameView().getyOffSet()), width, height, null);
	}
}
