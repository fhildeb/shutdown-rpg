...
/**
 * Diese Klasse dient zum Erstellen eines statischen "grosses rotes Haus"-Objektes
 * fuer die Spielwelt.
 * 
 * @author Felix Hildebrandt
 *
 */
public class HouseBigRed extends StaticEntity {
	 ...
	 * und die individuelle Kollisionsbox fuer das "grosses rotes Haus"-Objekt gesetzt.
	 * 
	 * @param handler Handler des "grosses rotes Haus"-Objektes
	 * @param x Position auf der X-Achse in der Spielwelt in Pixel
	 * @param y Position auf der Y-Achse in der Spielwelt in Pixel
	 */
	public HouseBigRed(Handler handler, float x, float y) {
	...
	public void render(Graphics paintbrush) {
		paintbrush.drawImage(Assets.house_big_red, (int) (x - handler.getGameView().getxOffSet()), (int) (y - handler.getGameView().getyOffSet()), width, height, null);
	}
}
